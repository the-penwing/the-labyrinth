# The Labyrinth Game Documentation
...
- [Screen Designs & Algorithms](./docs/screen-designs-and-algorithms.md)
- [Recorded Errors](./docs/errors-and-solutions.md)
- [Structure Chart](./docs/structure-chart.md)

---

Proudly Programmed on NixOS in NeoVim

Programmed in Python 3.14

Programmed and Designed by: Ben van Leeuwen (github@the-penwing)
